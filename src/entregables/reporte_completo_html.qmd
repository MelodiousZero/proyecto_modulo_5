...
Poisson ofreció una mejora significativa con respecto de Lasso, Ridge y Elastic Net, probablemente porque dado los supuestos es el modelo adecuado (lo vimos en la justificación) pero aún así está muy lejos del segundo grupo mencionado en la lista de arriba. 

La demanda debe de ser no-lineal debido a la relación entre las variables, por lo que los modelos del segundo grupo mencionado son mejores, estos captan las complejas interacciones y la fuerte estacionalidad horaria.
