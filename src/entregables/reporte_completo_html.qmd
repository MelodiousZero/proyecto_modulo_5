...
Puede que sea necesario usar un ambiente de python. Recuerda definir tu ambiente de python al inicio del documento `.qmd`  modificando `params` al inicio de este documento. 
